...
$data_file = "../questionnaire/app.data/poll-multi-choice.def/votes_Rpi1.txt";

//Here is the parameters of the ftp server
//$ftp_server="ftp.cluster007.ovh.net";
$ftp_server = "ftp.internet-jukebox.org";
$ftp_user_name="internetpk";
$ftp_user_pass="6v2MGfNBdb65";

//The file that I would like to upload to the ftp server.
