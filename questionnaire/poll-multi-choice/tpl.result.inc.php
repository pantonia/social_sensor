...
$myFile = "/Library/WebServer/Documents/questionnaire/app.data/latest_vote.txt";
$fh = fopen($myFile, "a");
...
//Here I upload the data file after 10 seconds the customer has viewed the results.
//If your raspberry is not connected to the internet, comment all the code below.
//If your raspberry pi is connected to the internet,uncomment the code to execute the upload data file.

//sleep(10);

//If your raspberry pi is connected to the internet, you can upload the datafile to the server by the code below.
//If not, when your raspberry pi is connected to the internet, view the results again, then the data file is upload to the server.
//include "../server/upload_datafile.php";
